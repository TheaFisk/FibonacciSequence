...
%% fibonacci.erl
%% 
%% A demonstration of Erlang functional programming concepts using the
%% Fibonacci sequence. Covers:
%%   - Output with io:format
%%   - Pattern matching in function parameters
%%   - Recursion
%%   - Guards
%%   - Lists
%%   - Lambda functions with lists:map, lists:filter, lists:foldl
%%   - Stretch: Exception throwing and handling
%%   - Stretch: case...of blocks
%%
%% HOW TO RUN IN VSCODE TERMINAL:
%%   1. Open the terminal (Ctrl + `)
%%   2. Compile:   erlc fibonacci.erl
%%   3. Run shell: erl
%%   4. In shell:  fibonacci:run_all().
%%   5. Or test individual functions, e.g.: fibonacci:fib(10).
%% =============================================================================
...
%% =============================================================================
%% run_all/0  —  Master demo: runs and prints all features
%% =============================================================================
...
run_all() ->
    ...
    %% --- Single Fibonacci numbers (pattern matching + recursion) ---
    ...
    %% --- Filter: even Fibonacci numbers (lists:filter + lambda) ---
